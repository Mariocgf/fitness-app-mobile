    ...
    <View className="flex-1 bg-slate-100 dark:bg-slate-950">
      ...
      >
        ...
        <View className="items-center mb-6">
          <View className="w-16 h-16 rounded-full bg-slate-200 dark:bg-slate-800 items-center justify-center">
            <Ionicons name="shield-outline" size={32} className="text-slate-500 dark:text-slate-400" />
          </View>
        </View>

        {/* Titles */}
        <Text className="text-2xl font-bold text-center text-slate-900 dark:text-slate-50 mb-3">
          Tu privacidad es lo primero
        </Text>
        <Text className="text-base text-center text-slate-500 dark:text-slate-400 mb-8 leading-relaxed">
          Para crear tu plan de entrenamiento y nutrición personalizado con IA, necesitamos procesar algunos datos sensibles.
        </Text>

        {/* Info Card */}
        <View className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 mb-8">
          <Text className="text-lg font-bold text-slate-900 dark:text-slate-50 mb-5">Lo que debes saber:</Text>

          {/* Item 1 */}
          <View className="flex-row items-start mb-5">
            <View className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 items-center justify-center mr-4 mt-1">
              <Ionicons name="medical-outline" size={20} className="text-slate-500 dark:text-slate-400" />
            </View>
            <View className="flex-1">
              <Text className="text-base font-bold text-slate-900 dark:text-slate-50 mb-1">Datos sensibles Protegidos</Text>
          ...
          <View className="flex-row items-start mb-5">
            <View className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 items-center justify-center mr-4 mt-1">
              <Ionicons name="hardware-chip-outline" size={20} className="text-slate-500 dark:text-slate-400" />
            </View>
            <View className="flex-1">
              <Text className="text-base font-bold text-slate-900 dark:text-slate-50 mb-1">Procesamiento Seguro</Text>
              <Text className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
          ...
          <View className="flex-row items-start">
            <View className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 items-center justify-center mr-4 mt-1">
              <Ionicons name="lock-closed-outline" size={20} className="text-slate-500 dark:text-slate-400" />
            </View>
            <View className="flex-1">
              <Text className="text-base font-bold text-slate-900 dark:text-slate-50 mb-1">Tú tienes el control</Text>
              <Text className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
        ...
        <View className="flex-row items-center mb-4 pr-4">
          <Switch
            ...
            trackColor={{ false: '#94a3b8', true: '#18181b' }}
            thumbColor="#ffffff"
            style={{ transform: [{ scaleX: 0.9 }, { scaleY: 0.9 }] }}
          />
          <View className="flex-1 ml-3">
            <Text className="text-sm text-slate-900 dark:text-slate-50 font-medium">
              Acepto el tratamiento de mis datos de salud y biométricos según la{' '}
              <Text
                className="text-slate-900 dark:text-slate-50 font-bold underline"
        ...
        <Text className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed mb-6">
      ...
      >
        <TouchableOpacity
          className={`w-full py-5 rounded-full items-center ${isAccepted ? 'bg-zinc-950 dark:bg-zinc-50' : 'bg-zinc-950/50 dark:bg-zinc-50/50'
            }`}
        ...
        >
          {isSubmitting ? (
            <ActivityIndicator className="text-white dark:text-slate-900" />
          ) : (
            <Text className="text-white dark:text-slate-900 text-lg font-bold">Continuar & Configurar</Text>
          )}
        </TouchableOpacity>
      </View>
      ...
      >
        <SafeAreaView className="flex-1 bg-slate-100 dark:bg-slate-950">
          <View className="flex-row items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-slate-800">
            <Text className="text-xl font-bold text-slate-900 dark:text-slate-50">Política de Privacidad</Text>
            <TouchableOpacity
              onPress={() => setShowPolicy(false)}
              className="w-8 h-8 items-center justify-center bg-slate-200 dark:bg-slate-800 rounded-full"
            >
              <Ionicons name="close" size={20} className="text-slate-500 dark:text-slate-400" />
            </TouchableOpacity>
          </View>
          <ScrollView className="flex-1 px-6 py-6">
            <Text className="text-base font-bold text-slate-900 dark:text-slate-50 mb-2">1. Marco Legal</Text>
            ...
            <Text className="text-base font-bold text-slate-900 dark:text-slate-50 mb-2">2. Responsable del Tratamiento</Text>
            <Text className="text-sm text-slate-500 dark:text-slate-400 mb-6 leading-relaxed">
              El tratamiento de los datos personales es responsabilidad del equipo de desarrollo de la plataforma.
            </Text>

            <Text className="text-base font-bold text-slate-900 dark:text-slate-50 mb-2">3. Datos Recabados y Finalidad</Text>
            <Text className="text-sm text-slate-500 dark:text-slate-400 mb-4 leading-relaxed">
            ...
            <View className="mb-6 ml-2">
              <Text className="text-sm text-slate-500 dark:text-slate-400 mb-2">
                <Text className="font-bold text-slate-900 dark:text-slate-50">• Datos de Identidad: </Text>
              ...
              <Text className="text-sm text-slate-500 dark:text-slate-400 mb-2">
                <Text className="font-bold text-slate-900 dark:text-slate-50">• Datos de Salud y Biométricos: </Text>
                (Datos Sensibles) Incluye fecha de nacimiento, peso, altura, medidas, lesiones, alergias y condiciones médicas.
              </Text>

              <Text className="text-sm text-slate-500 dark:text-slate-400">
                <Text className="font-bold text-slate-900 dark:text-slate-50">• Datos de Equipamiento: </Text>
                Inventario de herramientas de entrenamiento disponibles para ajustar las rutinas.
              </Text>
            </View>

            <Text className="text-base font-bold text-slate-900 dark:text-slate-50 mb-2">4. Tratamiento por Terceros y Seudonimización</Text>
            <Text className="text-sm text-slate-500 dark:text-slate-400 mb-2 leading-relaxed">
            ...
            <Text className="text-base font-bold text-slate-900 dark:text-slate-50 mb-2">5. Medidas de Seguridad</Text>
            <Text className="text-sm text-slate-500 dark:text-slate-400 mb-4 leading-relaxed">
              La plataforma implementa medidas técnicas para garantizar la confidencialidad:
            </Text>
            <View className="mb-6 ml-2">
              <Text className="text-sm text-slate-500 dark:text-slate-400 mb-2">
                <Text className="font-bold text-slate-900 dark:text-slate-50">• Gestión de Identidad Externa: </Text>
              ...
              <Text className="text-sm text-slate-500 dark:text-slate-400 mb-2">
                <Text className="font-bold text-slate-900 dark:text-slate-50">• Cifrado de Datos Sensibles: </Text>
              ...
              <Text className="text-sm text-slate-500 dark:text-slate-400">
                <Text className="font-bold text-slate-900 dark:text-slate-50">• Seudonimización: </Text>
              ...
              <Text className="text-sm text-slate-500 dark:text-slate-400">
                <Text className="font-bold text-slate-900 dark:text-slate-50">• Tráfico Seguro: </Text>
            ...
            <Text className="text-base font-bold text-slate-900 dark:text-slate-50 mb-2">6. Derechos de los Usuarios (ARCO)</Text>
            <Text className="text-sm text-slate-500 dark:text-slate-400 mb-6 leading-relaxed">
            ...
            <Text className="text-base font-bold text-slate-900 dark:text-slate-50 mb-2">7. Retención y Supresión</Text>
            <Text className="text-sm text-slate-500 dark:text-slate-400 mb-6 leading-relaxed">
